          ...
          messages: [
            {
              ...
              content: [
                ...
                {
                  type: "text",
                  text: "Transcribe this audio exactly as spoken. Return ONLY the transcribed text, nothing else. If the audio is silent or unintelligible, return an empty string.",
                },
              ],
            },
          ],
