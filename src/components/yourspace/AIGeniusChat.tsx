...
const GENIUS_SUGGESTIONS = [
  ...
  { label: "🇺🇸 Fulbright", message: "Tell me everything about the Fulbright Scholarship Program — all grant types (U.S. Student, Foreign Student, Scholar), eligibility, what it covers, application process, deadlines for the current cycle, and tips for a strong application. Based on my profile, which Fulbright programme am I eligible for and how should I prepare?" },
